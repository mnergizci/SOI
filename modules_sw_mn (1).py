...
def create_tab_file(prime_or_second, frame_dir, frame):
    tab_file = os.path.join(frame_dir, 'tab', prime_or_second + 'R_tab')
    if not os.path.exists(tab_file):
        inp=os.path.join('RSLC', prime_or_second, prime_or_second)
