...
if len(sys.argv) < 4:
    print('Please provide frame, pair and kernel size for median filtering of azimuth information: i.e python auto_cor_script.py 021D_05266_252525 20230129_20230210 64')
    sys.exit(1)
